...
Have your domain name registered and ready. Use it to add a new site in Cloudflare. Cloudflare will manage the DNS records for this domain. For this guide, I will use the **free** Cloudflare plan and my domain `cloudsandbox.online` as an example.

![Adding a Site to Cloudflare](assets/01-add-site-to-cloudflare.png)

You will be prompted to review your DNS records, but do not add anything just yet. Remember to update your authoritative DNS servers, or nameservers, at your domain registrar (such as GoDaddy or Namecheap) to point to Cloudflare.
